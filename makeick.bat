...
rem C-INTERCAL 0.28 compilation batch file for DJGPP.
...
set CFLAGS=-gstabs+ -O2 -DICKNOSEARCH -W -Wall -DICK_HAVE_STDINT_H=
...
bin2c.exe ick-clc_cset_latin1 < latin1.bin > cset-l.c
...
ranlib libyuk.a
echo parser.o lexer.o perpet.o feh2.o idiotism.o dekludge.o ick_lose.o fiddle.o uncommon.o > ickmgcc.rsp
...
copy /y pit\lib\syslib.?i lib
copy /y pit\explib\syslibc.c lib
copy /y pit\explib\compunex.c lib
copy /y COPYING.txt lib
copy /y src\fiddle.h include
copy /y src\ick_ec.h include
copy /y src\abcess.h include
copy /y src\ick_lose.h include
