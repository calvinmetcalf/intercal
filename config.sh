...
# Generated by GNU Autoconf 2.61 for C-INTERCAL 0.29.
#
...
if test "$ac_init_help" = "long"; then
  ...
  cat <<_ACEOF
\`configure' configures C-INTERCAL 0.29 to adapt to many kinds of systems.
...
if test -n "$ac_init_help"; then
  case $ac_init_help in
     short | recursive ) echo "Configuration of C-INTERCAL 0.29:";;
   esac
  cat <<\_ACEOF
...
It was created by C-INTERCAL $as_me 0.29, which was
...
ac_log="
This file was extended by C-INTERCAL $as_me 0.29, which was
generated by GNU Autoconf 2.61.  Invocation command line was
