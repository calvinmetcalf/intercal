...
echo "configure:848: checking for yywrap in -l$ac_lib" >&5
...
echo "configure:1007: checking for ANSI C header files" >&5
...
EOF
if { (eval echo configure:1087: \"$ac_link\") 1>&5; (eval $ac_link) 2>&5; } && test -s conftest${ac_exeext} && (./conftest; exit) 2>/dev/null
then
  :
else
  echo "configure: failed program was:" >&5
...
echo "configure:1114: checking for $ac_hdr" >&5
...
echo "configure:1227: checking size of long long int" >&5
...
echo "configure:1266: checking size of _Bool" >&5
...
echo "configure:1305: checking whether time.h and sys/time.h may both be included" >&5
...
echo "configure:1340: checking for Cygwin environment" >&5
...
echo "configure:1373: checking for mingw32 environment" >&5
...
echo "configure:1404: checking for executable suffix" >&5
...
echo "configure:1435: checking for object suffix" >&5
...
echo "configure:1459: checking lex output file root" >&5
...
echo "configure:1480: checking whether yytext is a pointer" >&5
...
echo "configure:1523: checking $ac_msg" >&5
...
echo "configure:1545: checking whether yyrestart() is needed" >&5
...
echo "configure:1587: checking return type of signal handlers" >&5
...
for ac_func in gettimeofday gethrtime strdup strtol strtoul
do
echo $ac_n "checking for $ac_func""... $ac_c" 1>&6
echo "configure:1630: checking for $ac_func" >&5
