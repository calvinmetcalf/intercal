...
# Generated by GNU Autoconf 2.61 for C-INTERCAL 1.29.
#
# Report bugs to <ais523(524\)x\((525)y)@bham.ac.uk>.
#
...
PACKAGE_TARNAME='c-intercal'
PACKAGE_VERSION='1.29'
PACKAGE_STRING='C-INTERCAL 1.29'
...
if test "$ac_init_help" = "long"; then
  ...
  cat <<_ACEOF
\`configure' configures C-INTERCAL 1.29 to adapt to many kinds of systems.
...
Fine tuning of the installation directories:
  ...
  --docdir=DIR           documentation root [DATAROOTDIR/doc/c-intercal]
...
if test -n "$ac_init_help"; then
  case $ac_init_help in
     short | recursive ) echo "Configuration of C-INTERCAL 1.29:";;
   esac
  cat <<\_ACEOF
...
It was created by C-INTERCAL $as_me 1.29, which was
...
ac_config_headers="$ac_config_headers temp/config.h:src/configh.in"
...
{ echo "$as_me:$LINENO: checking for $ac_word" >&5
echo $ECHO_N "checking for $ac_word... $ECHO_C" >&6; }
if test "${ac_cv_prog_INSTALLINFO+set}" = set; then
  echo $ECHO_N "(cached) $ECHO_C" >&6
else
...
if test -n "$INSTALLINFO"; then
  { echo "$as_me:$LINENO: result: $INSTALLINFO" >&5
echo "${ECHO_T}$INSTALLINFO" >&6; }
else
  { echo "$as_me:$LINENO: result: no" >&5
echo "${ECHO_T}no" >&6; }
fi
...
{ echo "$as_me:$LINENO: checking for $ac_word" >&5
echo $ECHO_N "checking for $ac_word... $ECHO_C" >&6; }
if test "${ac_cv_prog_MANDB+set}" = set; then
  echo $ECHO_N "(cached) $ECHO_C" >&6
else
...
if test -n "$MANDB"; then
  { echo "$as_me:$LINENO: result: $MANDB" >&5
echo "${ECHO_T}$MANDB" >&6; }
else
  { echo "$as_me:$LINENO: result: no" >&5
echo "${ECHO_T}no" >&6; }
...
{ echo "$as_me:$LINENO: checking for $ac_word" >&5
echo $ECHO_N "checking for $ac_word... $ECHO_C" >&6; }
if test "${ac_cv_prog_REALPATH+set}" = set; then
  echo $ECHO_N "(cached) $ECHO_C" >&6
else
...
if test -n "$REALPATH"; then
  { echo "$as_me:$LINENO: result: $REALPATH" >&5
echo "${ECHO_T}$REALPATH" >&6; }
else
  { echo "$as_me:$LINENO: result: no" >&5
echo "${ECHO_T}no" >&6; }
fi
...
{ echo "$as_me:$LINENO: WARNING: Info directory file not found in the --prefix you gave." >&5
echo "$as_me: WARNING: Info directory file not found in the --prefix you gave." >&2;}
{ echo "$as_me:$LINENO: WARNING: Info documentation will not be installed in the main directory tree." >&5
echo "$as_me: WARNING: Info documentation will not be installed in the main directory tree." >&2;}
{ echo "$as_me:$LINENO: WARNING: If you want to install in the main directory tree even though it's" >&5
echo "$as_me: WARNING: If you want to install in the main directory tree even though it's" >&2;}
{ echo "$as_me:$LINENO: WARNING: outside your --prefix, place a symlink to the directory file from" >&5
echo "$as_me: WARNING: outside your --prefix, place a symlink to the directory file from" >&2;}
{ echo "$as_me:$LINENO: WARNING: (your prefix)/share/info/dir and reconfigure." >&5
echo "$as_me: WARNING: (your prefix)/share/info/dir and reconfigure." >&2;}
INSTALLINFO=:
else
...
for ac_header in sys/time.h unistd.h stdarg.h
do
as_ac_Header=`echo "ac_cv_header_$ac_header" | $as_tr_sh`
if { as_var=$as_ac_Header; eval "test \"\${$as_var+set}\" = set"; }; then
  { echo "$as_me:$LINENO: checking for $ac_header" >&5
...
echo "$as_me: WARNING: $ac_header: in the future, the compiler will take precedence" >&2;}
    ( cat <<\_ASBOX
## ------------------------------------------------ ##
## Report this to ais523(524\)x\((525)y)@bham.ac.uk ##
## ------------------------------------------------ ##
_ASBOX
...
{ echo "$as_me:$LINENO: checking whether yyrestart() is needed" >&5
echo $ECHO_N "checking whether yyrestart() is needed... $ECHO_C" >&6; }
...
ac_config_files="$ac_config_files Makefile temp/coopt.sh:src/cooptsh.in"
...
ac_log="
This file was extended by C-INTERCAL $as_me 1.29, which was
generated by GNU Autoconf 2.61.  Invocation command line was
...
do
  case $ac_config_target in
    "temp/config.h") CONFIG_HEADERS="$CONFIG_HEADERS temp/config.h:src/configh.in" ;;
    "Makefile") CONFIG_FILES="$CONFIG_FILES Makefile" ;;
    "temp/coopt.sh") CONFIG_FILES="$CONFIG_FILES temp/coopt.sh:src/cooptsh.in" ;;
...
if test ! -n "$LEX"; then
  touch temp/lexer.c
  { echo "$as_me:$LINENO: WARNING: No version of lex was found, using prebuilt lexer.c." >&5
echo "$as_me: WARNING: No version of lex was found, using prebuilt lexer.c." >&2;}
  { echo "$as_me:$LINENO: WARNING: The lexer will not respond to changes in src/lexer.l unless you" >&5
echo "$as_me: WARNING: The lexer will not respond to changes in src/lexer.l unless you" >&2;}
  { echo "$as_me:$LINENO: WARNING: install a version of lex and reconfigure." >&5
echo "$as_me: WARNING: install a version of lex and reconfigure." >&2;}
else
  rm -f temp/lexer.c
fi
if test ! -n "$YACC"; then
  touch temp/oil.c temp/parser.c temp/parser.h
  { echo "$as_me:$LINENO: WARNING: No version of yacc was found, using prebuilt oil.c and parser.c." >&5
echo "$as_me: WARNING: No version of yacc was found, using prebuilt oil.c and parser.c." >&2;}
  { echo "$as_me:$LINENO: WARNING: The parsers will not respond to changes in source files unless you" >&5
echo "$as_me: WARNING: The parsers will not respond to changes in source files unless you" >&2;}
  { echo "$as_me:$LINENO: WARNING: install a version of yacc and reconfigure." >&5
echo "$as_me: WARNING: install a version of yacc and reconfigure." >&2;}
else
